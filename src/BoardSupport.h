...
#define GPIO_BUZZER					GPIO_PIN_7
#define GPIO_BUZZER_PIN_NUMBER		7
#define GPIO_BUZZER_PORT			GPIOA
#define GPIO_BUZZER_RCC				RCC_APB2ENR_IOPAEN

#define GPIO_BUZZER_OUT					GPIO_PIN_6
#define GPIO_BUZZER_OUT_PIN_NUMBER		6
#define GPIO_BUZZER_OUT_PORT			GPIOA
#define GPIO_BUZZER_OUT_RCC				RCC_APB2ENR_IOPAEN
